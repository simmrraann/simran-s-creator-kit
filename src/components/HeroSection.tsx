export const HeroSection = () => {
  const hero = {
    ...
    description: "I create viral content around AI tools, student life, productivity, and self-growth helping over 2.4M+ viewers learn smarter every month.",
